...
@section('title', 'Teacher Login - MRJR Management System')
            ...
            <div class="card shadow-lg border-0">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <h1 class="mb-2">Teacher Login</h1>
                        <p class="text-muted">Sign in to access your teacher dashboard</p>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-muted mb-2">Not a teacher or forgot your password?</p>
