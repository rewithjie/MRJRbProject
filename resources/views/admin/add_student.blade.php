...
@section('title', 'Add New Student - Admin Dashboard')
        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('admin.store.student') }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('degree_id') is-invalid @enderror" 
                ...
                <a href="{{ route('admin.manage.students') }}" class="btn-back">
